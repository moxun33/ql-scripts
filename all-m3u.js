...
const douyuM3u = fs.readFileSync(path.resolve(__dirname,'./data/douyu.m3u')).toString()
const biliM3u = fs.readFileSync(path.resolve(__dirname,'./data/bilibili.m3u')).toString()
const huyaM3u = fs.readFileSync(path.resolve(__dirname,'./data/huya.m3u')).toString()
